            ...
            <div class="row">
                <div class="col-12 col-xl-10 offset-xl-1">
                    <table class="table cart-table">
                        ...
                        <?php include 'wishlistContent.php' ?>
                    </table>
                </div>
            </div><!-- end row -->
        </div><!-- end container -->
...
// Remove item from wishlist script
<script>
    $('.rmvBtn').click(function (e) {
        e.preventDefault();
        var itemId = $(this).closest('.parent-rmvBtn').attr('data-id');
        $.ajax({
...
<script>
    $(document).ready(function () {
        $('.button-circle.button-circle-md.button-circle-gray').click(function (e) {
            e.preventDefault();
            var itemId = $(this).closest('.button-parent').attr('data-id');
            $.ajax({
                url: 'cartRefresh.php',
                method: 'POST',
